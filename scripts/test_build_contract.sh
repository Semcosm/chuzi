...
[ -f "$repo_root/launcher-ui/src/desktop.rs" ] || fail "launcher UI desktop bridge is missing"
[ -f "$repo_root/launcher-ui/src/ui.html" ] || fail "launcher UI document is missing"
